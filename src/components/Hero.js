...
const Hero = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-10 text-center lg:text-left">
          <div className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 leading-[0.9] tracking-tighter">
              Crafting <br />
              <span className="text-primary-container italic font-serif">Digital</span> <br />
            ...
            <div className="h-12 flex items-center justify-center lg:justify-start">
              <span className="text-xl md:text-2xl font-medium text-slate-400">
                I am <span className="text-slate-900 font-bold border-b-2 border-primary-container/30">{displayText}</span>
                <motion.span
                  animate={{ opacity: [1, 0] }}
          ...
          >
            ...
            <motion.button 
              whileHover={{ scale: 1.05, backgroundColor: "rgba(0,193,142,0.05)" }}
              whileTap={{ scale: 0.95 }}
          ...
          >
            {[
              { icon: GithubIcon, color: "hover:text-primary-container" },
              { icon: LinkedinIcon, color: "hover:text-primary-container" },
              { icon: FacebookIcon, color: "hover:text-primary-container" }
            ].map((social, i) => (
              <motion.a 
                key={i} 
                href="#" 
        ...
        <div className="relative flex justify-center perspective-1000">
          ...
          >
            ...
            {floatingIcons.map((icon, index) => (
              ...
              >
                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: icon.color }} />
                <span className="text-sm font-black text-slate-900">{icon.name}</span>
              </motion.div>
            ))}
      ...
      >
        <span className="text-[10px] font-black uppercase tracking-widest text-slate-900">Scroll</span>
